...
public partial class DatabaseManager : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BusyAppointment>(entity =>
        {
            ...
            entity.Property(e => e.ClientId).HasMaxLength(10).IsFixedLength();
            entity.Property(e => e.TherapistId).HasMaxLength(10).IsFixedLength();
        ...
        modelBuilder.Entity<Client>(entity =>
        {
            ...
            entity.Property(e => e.PhoneNumber).HasMaxLength(10).IsFixedLength();
            entity.Property(e => e.TherapistId).HasMaxLength(10).IsFixedLength();
        });
